(function () {
    ...
    // Détermination de l'URL racine pour les fichiers statiques/uploads basée sur API_URL
    const BASE_URL = (typeof API_BASE_URL !== 'undefined') 
        ? API_BASE_URL 
        : (typeof API_URL !== 'undefined' ? API_URL.replace(/\/api\/?$/, '') : '');
    ...
    function formatImageSrc(imagePath) {
        ...
        // 1. Data URL (Base64 déjà formatée)
